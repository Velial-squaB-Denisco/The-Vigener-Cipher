...
Эта документация более подробно описывает функциональность класса, его методы и особенности использования. Вы можете дополнить её, добавив больше примеров или уточнив детали, если это необходимо.
